...
const EXTRA = {
  en: {
    ...
    'settings.hapticsHelp': 'Short vibrations when you tap, rate and save.',
  ...
  fr: {
    ...
    'settings.haptics': 'Vibrations',
    'settings.hapticsHelp': 'De courtes vibrations quand vous notez, changez un réglage ou enregistrez.',
