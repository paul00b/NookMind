    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative z-10 w-full max-w-sm h-full bg-[#f8f6f1] dark:bg-[#1a1f2e] border-l border-black/[0.08] dark:border-white/[0.08] overflow-y-auto animate-slide-in-right flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 pb-4 border-b border-black/[0.06] dark:border-white/[0.06]">
          <h2 className="font-serif text-xl font-bold text-gray-900 dark:text-gray-100">Settings</h2>
        ...
        <div className="flex-1 p-6 space-y-8">
          {/* Profile */}
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-4">Profile</h3>
              ...
              {editingName ? (
                <div className="w-full space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button onClick={handleSaveName} className="btn-primary text-sm py-1.5 flex-1">Save</button>
                    <button onClick={() => setEditingName(false)} className="btn-ghost text-sm py-1.5 flex-1">Cancel</button>
                  </div>
                </div>
              ) : (
          ...
          {/* Appearance */}
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-4">Appearance</h3>
          ...
          {/* About */}
          <section>
            <h3 className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-4">About</h3>
